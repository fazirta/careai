...
function RecordAnswerSection({
  ...
  const UpdateUserAnswer = async () => {
    ...
    const feedbackPrompt =
      "Pertanyaan:" +
      mockChatSessionQuestion[activeQuestionIndex]?.question +
      ", Jawaban User:" +
      userAnswer +
      ", Dari pertanyaan dan jawaban user untuk Analisa Penyakitnya " +
      " Tolong berikan Analisa konkrit, mengenai Penyakit apa Yang dialami user " +
      " in just 3 to 5 lines to improve it in JSON format with and feedback field. Answer Using" +
      chatSessionData?.language +
      " Language";
