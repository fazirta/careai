...
function Feedback({ params }) {
    ...
    const GetFeedback = async () => {
        const result = await db.select().from(UserAnswer).where(eq(UserAnswer.mockIdRef, params.chatsessionId)).orderBy(UserAnswer.id)
    ...
    return (
        <div className='p-10'>
            ...
            <h2 className='font-bold text-2xl'>Here's your AI Analysis Feedback</h2>
